...
import { FiltroPropiedadesPipe } from './consultar-propiedades/filtro-propiedades.pipe';

import { HistorialDeudasComponent } from './historial-deudas/historial-deudas.component';
...
@NgModule({
  declarations: [
    ...
    DeudasComponent,
    ConsultarUsuariosTesoreroComponent,
    FiltroPropiedadesPipe,
    HistorialDeudasComponent
